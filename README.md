...
**This library may be phased out because new web services provide equivalent functionality.**
...
|[`cdss-lib-dmi-hydrobase-java`](https://github.com/OpenWaterFoundation/cdss-lib-dmi-hydrobase-java)   |Library for Colorado HydroBase database.|
