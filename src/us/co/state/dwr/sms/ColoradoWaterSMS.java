    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(us.co.state.dwr.sms.ColoradoWaterSMS.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = us.co.state.dwr.sms.ColoradoWaterSMS.class.getResource(".");
    ...
    */
    ...
    throws MalformedURLException
    {
        super(new URL(wsdlLocation), new QName("http://www.dwr.state.co.us/", "ColoradoWaterSMS"));
    }
